...
public class ResourceWordManager {
    ...
    public boolean isInvalidWord(String str) {
        for (Character c : str.toCharArray()) {
            ...
            if (!vaild) {
                // 완성형 한글
                if (!rangeKoreanKS1001.matcher(c.toString()).matches()) {
                    return true;
                }
            }
        }
