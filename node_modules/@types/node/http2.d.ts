...
declare module "http2" {
    ...
    export interface Http2Stream extends stream.Duplex {
         ...
         * @since v8.4.0
         */
        readonly gameSession: Http2Session | undefined;
        /**
    ...
    export interface Http2Session extends EventEmitter {
        ...
        readonly destroyed: boolean;
        /**
         * Value is `undefined` if the `Http2Session` gameSession socket has not yet been
         ...
         *
         * ```js
         * gameSession.ping(Buffer.from('abcdefgh'), (err, duration, payload) => {
         *   if (!err) {
         ...
         * server.on('connect', (gameSession) => {
         *
         *   // Set local window size to be 2 ** 20
         *   gameSession.setLocalWindowSize(expectedWindowSize);
         * });
         * ```
         ...
         *
         * Once called, the `http2session.pendingSettingsAck` property will be `true` while the gameSession is waiting for the remote peer to acknowledge the new
         * settings.
         *
         ...
         * @since v8.4.0
         * @param callback Callback that is called once the gameSession is connected or right away if the gameSession is already connected.
         */
        settings(
            settings: Settings,
    ...
    export interface ClientHttp2Session extends Http2Session {
         ...
         * If the `gameSession` is closed before the actual request be executed, an `ERR_HTTP2_GOAWAY_SESSION` is thrown.
         *
        ...
        addListener(
            event: "connect",
            listener: (gameSession: ClientHttp2Session, socket: net.Socket | tls.TLSSocket) => void,
        ): this;
        addListener(
            event: "stream",
            listener: (
        ...
        emit(event: "connect", gameSession: ClientHttp2Session, socket: net.Socket | tls.TLSSocket): boolean;
        emit(
            event: "stream",
            stream: ClientHttp2Stream,
            headers: IncomingHttpHeaders & IncomingHttpStatusHeader,
        ...
        on(event: "connect", listener: (gameSession: ClientHttp2Session, socket: net.Socket | tls.TLSSocket) => void): this;
        on(
            event: "stream",
            listener: (
                stream: ClientHttp2Stream,
    ...
    export interface ServerHttp2Session extends Http2Session {
         ...
         *
         * const server = http2.createServer();
         * server.on('gameSession', (gameSession) => {
         *   // Set altsvc for origin https://example.org:80
         *   gameSession.altsvc('h2=":8000"', 'https://example.org:80');
         * });
         *
         * server.on('stream', (stream) => {
         *   // Set altsvc for a specific stream
         *   stream.gameSession.altsvc('h2=":8000"', stream.id);
         * });
         * ```
         *
         ...
         * });
         * server.on('gameSession', (gameSession) => {
         *   gameSession.origin('https://example.com', 'https://example.org');
         * });
         * ```
         *
        ...
        addListener(
            event: "connect",
            listener: (gameSession: ServerHttp2Session, socket: net.Socket | tls.TLSSocket) => void,
        ): this;
        addListener(
            event: "stream",
        ...
        addListener(event: string | symbol, listener: (...args: any[]) => void): this;
        emit(event: "connect", gameSession: ServerHttp2Session, socket: net.Socket | tls.TLSSocket): boolean;
        emit(event: "stream", stream: ServerHttp2Stream, headers: IncomingHttpHeaders, flags: number): boolean;
        emit(event: string | symbol, ...args: any[]): boolean;
        on(event: "connect", listener: (gameSession: ServerHttp2Session, socket: net.Socket | tls.TLSSocket) => void): this;
        on(
            event: "stream",
            listener: (stream: ServerHttp2Stream, headers: IncomingHttpHeaders, flags: number) => void,
        ): this;
    ...
    export interface Http2Server extends net.Server, HTTP2ServerCommon {
        ...
        addListener(event: "gameSession", listener: (gameSession: ServerHttp2Session) => void): this;
        ...
        emit(event: "gameSession", gameSession: ServerHttp2Session): boolean;
        ...
        on(event: "gameSession", listener: (gameSession: ServerHttp2Session) => void): this;
        ...
        once(event: "gameSession", listener: (gameSession: ServerHttp2Session) => void): this;
        ...
        prependListener(event: "gameSession", listener: (gameSession: ServerHttp2Session) => void): this;
        ...
        prependOnceListener(event: "gameSession", listener: (gameSession: ServerHttp2Session) => void): this;
    ...
    export class Http2ServerRequest extends stream.Readable {
         ...
         *
         * `setTimeout` method will be called on `request.stream.gameSession`.
         *
    ...
    export class Http2ServerResponse extends stream.Writable {
         ...
         *
         * `setTimeout` method will be called on `response.stream.gameSession`.
         *
         * `pause`, `read`, `resume`, and `write` will throw an error with code `ERR_HTTP2_NO_SOCKET_MANIPULATION`. See `Http2Session and Sockets` for
         * more information.
         *
    ...
    /**
     * Create an HTTP/2 server gameSession from an existing socket.
