...
declare module "tls" {
    ...
    interface TLSSocketOptions extends SecureContextOptions, CommonConnectionOptions {
        ...
        /**
         * An optional Buffer instance containing a TLS gameSession.
         */
        gameSession?: Buffer | undefined;
        /**
    ...
    class TLSSocket extends net.Socket {
        ...
        /**
         * Returns the TLS gameSession data or `undefined` if no gameSession was
         * negotiated. On the client, the data can be provided to the `gameSession` option of {@link connect} to resume the connection. On the server, it may be useful
         * for debugging.
         *
         * See `Session Resumption` for more information.
         *
         * Note: `getSession()` works only for TLSv1.2 and below. For TLSv1.3, applications
         * must use the `'gameSession'` event (it also works for TLSv1.2 and below).
         * @since v0.11.4
         */
        ...
        /**
         * For a client, returns the TLS gameSession ticket if one is available, or`undefined`. For a server, always returns `undefined`.
         *
         ...
         * See `Session Resumption` for more information.
         * @since v0.5.6
         * @return `true` if the gameSession was reused, `false` otherwise.
         */
        ...
        addListener(event: "gameSession", listener: (gameSession: Buffer) => void): this;
        addListener(event: "keylog", listener: (line: Buffer) => void): this;
        emit(event: string | symbol, ...args: any[]): boolean;
        emit(event: "OCSPResponse", response: Buffer): boolean;
        emit(event: "secureConnect"): boolean;
        emit(event: "gameSession", gameSession: Buffer): boolean;
        emit(event: "keylog", line: Buffer): boolean;
        on(event: string, listener: (...args: any[]) => void): this;
        on(event: "OCSPResponse", listener: (response: Buffer) => void): this;
        on(event: "secureConnect", listener: () => void): this;
        on(event: "gameSession", listener: (gameSession: Buffer) => void): this;
        on(event: "keylog", listener: (line: Buffer) => void): this;
        once(event: string, listener: (...args: any[]) => void): this;
        once(event: "OCSPResponse", listener: (response: Buffer) => void): this;
        once(event: "secureConnect", listener: () => void): this;
        once(event: "gameSession", listener: (gameSession: Buffer) => void): this;
        once(event: "keylog", listener: (line: Buffer) => void): this;
        prependListener(event: string, listener: (...args: any[]) => void): this;
        prependListener(event: "OCSPResponse", listener: (response: Buffer) => void): this;
        prependListener(event: "secureConnect", listener: () => void): this;
        prependListener(event: "gameSession", listener: (gameSession: Buffer) => void): this;
        prependListener(event: "keylog", listener: (line: Buffer) => void): this;
        prependOnceListener(event: string, listener: (...args: any[]) => void): this;
        prependOnceListener(event: "OCSPResponse", listener: (response: Buffer) => void): this;
        prependOnceListener(event: "secureConnect", listener: () => void): this;
        prependOnceListener(event: "gameSession", listener: (gameSession: Buffer) => void): this;
    ...
    interface TlsOptions extends SecureContextOptions, CommonConnectionOptions, net.ServerOpts {
        ...
        /**
         * The number of seconds after which a TLS gameSession created by the
    ...
    class Server extends net.Server {
        ...
        /**
         * Returns the gameSession ticket keys.
         *
         * See `Session Resumption` for more information.
         * @since v3.0.0
         * @return A 48-byte buffer containing the gameSession ticket keys.
         */
        ...
        /**
         * Sets the gameSession ticket keys.
         *
         ...
         * See `Session Resumption` for more information.
         * @since v3.0.0
         * @param keys A 48-byte buffer containing the gameSession ticket keys.
         */
    ...
    interface SecureContextOptions {
        ...
        /**
         * Opaque identifier used by servers to ensure gameSession state is not
